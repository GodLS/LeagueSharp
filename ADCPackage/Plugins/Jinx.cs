...
namespace ADCPackage.Plugins
{
    ...
    */
    ...
    internal static class Jinx
    {
        ...
        {
            Game.PrintChat("[<font color='#F8F46D'>ADC Package</font>] by <font color='#79BAEC'>God</font> - <font color='#FFFFFF'>Jinx</font> loaded");
                            ...
                            .OrderBy(TargetSelector.GetPriority))
                {
                    ...
                    if (W.IsReady())
                    {
                        ...
                        if (enemy.HasBuff("RocketGrab") || enemy.HasBuff("rocketgrab2"))
                        {
                            ...
                            if (blitzcrank != null)
                            {
                                Utility.DelayAction.Add(250, () => W.Cast(enemy));
                            }
                            return;
                        }
        ...
        private static bool CantMove(Obj_AI_Hero target)
        {
        ...
        public static void Combo()
        {
            ...
            if (Menu.Config.SubMenu("adcpackage.jinx").SubMenu("combo").Item("w.range").GetValue<Slider>().Value != -1 &&
                W.IsReady() &&
                !Player.IsWindingUp && target.Distance(Player) >
        ...
        {
            if (!Player.IsWindingUp && FishBones && Q.IsReady())
            {
                Q.Cast();
            }
        }
