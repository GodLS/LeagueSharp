...
namespace ADCPackage
{
    public static class CustomOrbwalker
    {
        ...
        private static void Obj_AI_Base_OnDoCast(Obj_AI_Base unit, GameObjectProcessSpellCastEventArgs Spell)
        {
            ...
            //    Utility.DelayAction.Add((int)delay, () => _missileLaunched = false);
            //}
        }
